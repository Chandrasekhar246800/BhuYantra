...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { name: 'Agricultural Consultation', href: '#contact' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              Revolutionizing agriculture through satellite-based crop monitoring, AI-powered insights, 
              and sustainable farming solutions for the future.
            </p>
            
            {/* PDF Download CTA */}
            <button
              onClick={handlePDFDownload}
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white text-sm font-semibold rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900"
            >
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <button className="px-6 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
